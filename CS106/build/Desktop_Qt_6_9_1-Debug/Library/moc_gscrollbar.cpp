...
#include "../../../Library/graphics/gscrollbar.h"
...
namespace {
struct qt_meta_tag_ZN20_Internal_QScrollBarE_t {};
} // unnamed namespace

template <> constexpr inline auto _Internal_QScrollBar::qt_create_metaobjectdata<qt_meta_tag_ZN20_Internal_QScrollBarE_t>()
{
    ...
    return QtMocHelpers::metaObjectData<_Internal_QScrollBar, qt_meta_tag_ZN20_Internal_QScrollBarE_t>(QMC::MetaObjectFlag{}, qt_stringData,
...
Q_CONSTINIT const QMetaObject _Internal_QScrollBar::staticMetaObject = { {
    ...
    qt_staticMetaObjectStaticContent<qt_meta_tag_ZN20_Internal_QScrollBarE_t>.stringdata,
    qt_staticMetaObjectStaticContent<qt_meta_tag_ZN20_Internal_QScrollBarE_t>.data,
    qt_static_metacall,
    nullptr,
    qt_staticMetaObjectRelocatingContent<qt_meta_tag_ZN20_Internal_QScrollBarE_t>.metaTypes,
    nullptr
} };
...
void *_Internal_QScrollBar::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_staticMetaObjectStaticContent<qt_meta_tag_ZN20_Internal_QScrollBarE_t>.strings))
