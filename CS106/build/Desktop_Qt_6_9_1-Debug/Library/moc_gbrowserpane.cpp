...
template <> constexpr inline auto _Internal_QTextBrowser::qt_create_metaobjectdata<qt_meta_tag_ZN22_Internal_QTextBrowserE_t>()
{
    ...
    return QtMocHelpers::metaObjectData<_Internal_QTextBrowser, qt_meta_tag_ZN22_Internal_QTextBrowserE_t>(QMC::MetaObjectFlag{}, qt_stringData,
...
Q_CONSTINIT const QMetaObject _Internal_QTextBrowser::staticMetaObject = { {
    ...
    qt_staticMetaObjectStaticContent<qt_meta_tag_ZN22_Internal_QTextBrowserE_t>.stringdata,
    qt_staticMetaObjectStaticContent<qt_meta_tag_ZN22_Internal_QTextBrowserE_t>.data,
    qt_static_metacall,
    nullptr,
    qt_staticMetaObjectRelocatingContent<qt_meta_tag_ZN22_Internal_QTextBrowserE_t>.metaTypes,
    nullptr
} };
...
void *_Internal_QTextBrowser::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_staticMetaObjectStaticContent<qt_meta_tag_ZN22_Internal_QTextBrowserE_t>.strings))
