...
#include "../../../Library/graphics/gslider.h"
...
namespace {
struct qt_meta_tag_ZN17_Internal_QSliderE_t {};
} // unnamed namespace

template <> constexpr inline auto _Internal_QSlider::qt_create_metaobjectdata<qt_meta_tag_ZN17_Internal_QSliderE_t>()
{
    ...
    return QtMocHelpers::metaObjectData<_Internal_QSlider, qt_meta_tag_ZN17_Internal_QSliderE_t>(QMC::MetaObjectFlag{}, qt_stringData,
            qt_methods, qt_properties, qt_enums);
}
Q_CONSTINIT const QMetaObject _Internal_QSlider::staticMetaObject = { {
    QMetaObject::SuperData::link<QSlider::staticMetaObject>(),
    qt_staticMetaObjectStaticContent<qt_meta_tag_ZN17_Internal_QSliderE_t>.stringdata,
    qt_staticMetaObjectStaticContent<qt_meta_tag_ZN17_Internal_QSliderE_t>.data,
    qt_static_metacall,
    nullptr,
    qt_staticMetaObjectRelocatingContent<qt_meta_tag_ZN17_Internal_QSliderE_t>.metaTypes,
    nullptr
} };
...
void *_Internal_QSlider::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_staticMetaObjectStaticContent<qt_meta_tag_ZN17_Internal_QSliderE_t>.strings))
